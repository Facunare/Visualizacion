...
function Conclusion() {
  return (
    <section>
        <h4 className="firstH4 conclusion">CONCLUSIÓN</h4>
        ...
        <p className="storytelling_2 conclusion">Noventa y dos años de historia mundialista producen una paradoja: <span className="highlight">menos goles, pero 
            cada uno de ellos vale infinitamente más que antes</span>.</p>
